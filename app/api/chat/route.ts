...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const sys = [
      ...
      "If 'Curated spots' context is given, ground venue-specific facts (area, vibe, monsoon suitability, cost, top dishes) STRICTLY in that data — never invent an address, price, opening hours, or dish for a place listed there. If exactly one curated entry for that venue name is given and the user's message names a different area/location for it, open your reply by correcting them to the area you were given (e.g. 'Actually, Bayroute Bandra is in Pali Naka, not Powai') — but if the venue is a recognizable chain/brand (multiple outlets are plausible) and you only have one branch in your data, don't flatly deny the other location exists — say your data covers the branch at the given area and that other outlets may exist elsewhere.",
